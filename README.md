...
- Controlled generation — steer the motion with optional [Kimodo constraints](https://research.nvidia.com/labs/sil/projects/kimodo/docs/key_concepts/constraints.html) (root 2D path/waypoints, full-body keyframes, hand/foot targets) supplied as JSON on the node; see [HDA Documentation](hda/README.md#constraints-optional)
